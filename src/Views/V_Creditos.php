            ...
            <div class="modal-content border-0 shadow" style="border-radius: 1rem;">
                <form action="?c=Pagos&accion=insert" method="POST" id="formWizardPago">
                    ...
                    <div id="wizardStep2" class="p-4 d-none">
                        ...
                        <div class="mb-4" id="div_referencia_wizard">
                            <label class="form-label fw-bold">Referencia / Comprobante</label>
                            <input type="text" name="referencia[]" id="input_referencia_wizard" class="form-control form-control-lg" placeholder="Ej: 12345678" required style="border-radius: 10px;">
                        </div>
