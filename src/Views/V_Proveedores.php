...
<body>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="">
                                    ...
                                    <form action="index.php?c=pacientes&a=EliminarPacientes" method="POST" style="display:inline;">
    ...
    <div class="modal fade" id="pacienteModal" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="pacienteModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="pacienteModalLabel">Crear Proveedor</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="needs-validation" method="POST" action="index.php?c=proveedores&a=GuardarProveedores" id="pacienteForm">
                        ...
                        <div class="container container-form">
                            ...
                            <div class="mb-3">
                                <label for="apellido" class="form-label">RIF</label>
                                <input type="text" minlength="5" maxlength="15" title="Ingrese solo texto" name="rif" class="form-control" id="rif" placeholder="RIF" required />
                            </div>

                            <div class='mb-3'>
                                <label for='numero_telefono' class='form-label'>Teléfono</label>
                                <input type='text' class='form-control' pattern="[0-9]{9,11}" title="ingrese solo numeros, entre 9 y 11 caracteres" id='numero_telefono' name='telefono' placeholder="teléfono" required />
                            </div>
